#!/usr/bin/env python3
"""Stage 1: pretrain nominal-action-conditioned future latent prediction."""
...
def parse_args():
    ...
    parser.add_argument("--config", default="configs/mowe_wam/train_latent_wam_pretrain.yaml")
...
def main() -> None:
    ...
    run_training(cfg, stage="pretrain", resume=args.resume)
